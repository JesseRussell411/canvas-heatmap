...
},{"../dist_heatmap/HeatmapGenerator.js":2}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class HeatmapGenerator {
     ...
     */
    colorize(gradient = this.gradientData, { transparent = false } = {}) {
        if (!(gradient instanceof Uint8ClampedArray)) {
            return this.colorize((0, gradientGenerator_1.generateGradient)(gradient), { transparent });
        }
        if (this.width === 0 || this.height === 0)
            return;
    ...
    decolorize(gradient = this.gradientData, { transparent = false } = {}) {
        if (!(gradient instanceof Uint8ClampedArray)) {
            return this.decolorize((0, gradientGenerator_1.generateGradient)(gradient));
        }
        const getKey = transparent
            ? (i, gradient) => `${gradient[i + 0]}${gradient[i + 1]}${gradient[i + 2]}`
            : (i, gradient) => `${gradient[i + 0]}${gradient[i + 1]}${gradient[i + 2]}${gradient[i + 3]}`;
        // create reverse gradient
        const reverseGradient = new Map();
...
},{"./gradientGenerator":3}],3:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
Object.defineProperty(exports, "__esModule", { value: true });
exports.generateGradient = exports.defaultGradient = exports.defaultGradientStops = void 0;
const color_1 = __importDefault(require("color"));
exports.defaultGradientStops = {
    1: "red",
    0.5: "yellow",
    0: "blue",
};
exports.defaultGradient = generateGradient(exports.defaultGradientStops);
/**
 ...
 */
function generateGradient(colorStops) {
    if (undefined === colorStops)
        return exports.defaultGradient;
    if (Array.isArray(colorStops)) {
        ...
        const colorStopsObject = Object.fromEntries(colorStops.map((color, i) => [i / (colorStops.length - 1), color]));
    ...
    preppedColorStops.forEach(stop => (stop[0] *= 255));
    ...
    for (let i = 0; i < 256; i++) {
        ...
        if (totalDistance === 0) {
            ...
            result[ri + 0] = calcChannel("red", colorStop1, colorStop2, colorStopDistance1, colorStopDistance2, totalDistance);
            result[ri + 1] = calcChannel("green", colorStop1, colorStop2, colorStopDistance1, colorStopDistance2, totalDistance);
            result[ri + 2] = calcChannel("blue", colorStop1, colorStop2, colorStopDistance1, colorStopDistance2, totalDistance);
            result[ri + 3] = calcChannel("alpha", colorStop1, colorStop2, colorStopDistance1, colorStopDistance2, totalDistance);
        }
    }
    // I hope this function gets inlined
    /** Calculate the value for a channel. */
    function calcChannel(channel, colorStop1, colorStop2, colorStopDistance1, colorStopDistance2, totalDistance) {
